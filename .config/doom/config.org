...
(meow-setup)
(meow-global-mode 1)
(meow-leader-define-key '("c" . "<f6> c"))
(meow-leader-define-key '("i" . "<f6> i"))
(meow-leader-define-key '("n" . "<f6> n"))
(meow-leader-define-key '("p" . "<f6> p"))
;; (meow-leader-define-key '("b" . "<f6> b"))
(meow-leader-define-key '("f" . "<f6> f"))
(meow-leader-define-key '("q" . "<f6> q"))
(meow-leader-define-key '("t" . "<f6> t"))
(meow-leader-define-key '("s" . "<f6> s"))
(meow-leader-define-key '("v" . "<f6> v"))
(meow-leader-define-key '("w" . ace-window))
(meow-leader-define-key '("a" . ace-window))
(meow-leader-define-key '("," . consult-buffer))
(meow-leader-define-key '("l" . "<f7>"))
(meow-leader-define-key '("SPC" . projectile-find-file))
