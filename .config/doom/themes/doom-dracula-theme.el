...
(def-doom-theme doom-dracula
  ...
  (((line-number &override) :foreground base5)
   ...
   (outline-1 :inherit 'outline-1 :foreground level1)
   (outline-2 :inherit 'outline-2 :foreground level2)
   (outline-3 :inherit 'outline-3 :foreground level3)
   (outline-4 :inherit 'outline-4 :foreground level4)
   (outline-5 :inherit 'outline-5 :foreground level5)
   (outline-6 :inherit 'outline-6 :foreground level6)
   (outline-7 :inherit 'outline-7 :foreground level7)
   (outline-8 :inherit 'outline-8 :foreground level8)
   ;;;; org <built-in>
