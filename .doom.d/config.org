...
(map! :nvieomg "C-t" #'avy-goto-char-timer
        :map magit-mode-map :n "C-t" #'avy-goto-char-timer
        :map evil-org-mode-map :i "C-t" #'avy-goto-char-timer)

(setq avy-keys '(?n ?s ?e ?r ?i ?a ?o ?d ?h ?f ?u ?p ?l ?w ?y ?c ?, ?x ?. ?g ?m ?v ?k))
