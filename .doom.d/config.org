...
(after! emacs-everywhere
  ...
  (add-hook 'emacs-everywhere-init-hooks (cmd! (text-scale-increase 1)))
  ;; (add-hook 'emacs-everywhere-init-hooks (cmd! (toggle-frame-tab-bar)))
  (push '(tab-bar-format . 0) emacs-everywhere-frame-parameters)
  (push '(tab-bar-lines . 0) emacs-everywhere-frame-parameters)
  (push '(tab-bar-lines-keep-state . 0) emacs-everywhere-frame-parameters)
  (push '(internal-border-width . 10) emacs-everywhere-frame-parameters)
  )
